...
add_tool_handler(tools.EchoToolHandler())
add_tool_handler(tools.LoadEmbeddingsToolHandler())
add_tool_handler(tools.ChromaIndexToolHandler())
add_tool_handler(tools.ChromaQueryToolHandler())
